...
import udacity.uelordi.com.popularmovies.database.MovieDBHelper;
import udacity.uelordi.com.popularmovies.database.MoviesProvider;

/**
 * Created by uelordi on 24/03/17.
 */
...
public class TestMovieContentProvider {
    ...
    public void testProviderRegistry() {
        ...
        String taskProviderClassName = MoviesProvider.class.getName();
    ...
    public void testUriMatcher() {
        ...
        int expectedTasksMatchCode = MoviesProvider.MOVIES;
        ...
        int expectedTaskWithIdCode = MoviesProvider.MOVIE_WITH_ID;
    ...
    public void testInsert() {
        ...
        testMovieValues.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE,"release_date");
        testMovieValues.put(MovieContract.MovieEntry.COLUMN_USER_RATING,9.8);
